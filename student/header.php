...
<head>
    ...
    <link href="../admin/plugins/jQueryUI/jquery-ui.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="../admin/plugins/jQuerydatetimepicker/jquery.datetimepicker.css" />
    <link rel="stylesheet" href="../admin/css/uploadfiles.css" type="text/css">
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="dashboard.php" class="logo">
                    ...
                    <span class="logo-lg"><b><i class="fa fa-book"></i>&nbsp;&nbsp;&nbsp;&nbsp; TOT IRIS</b></span>
                </a>
